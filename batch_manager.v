...
(
    ...
    input  [RBB_WR_ADDR_WIDTH*NUM_PEA-1:0]   pe2bm_rbbWrAddr_b;
    input  [RBB_WR_DATA_WIDTH*NUM_PEA-1:0]   pe2bm_rbbWrDin_b;
                    ...
                    begin
                      //check if the RBB is willing to write data
                        ...
                        begin
                            ...
                            WrReqId[6+RBB_RD_ADDR_WIDTH-1:0] = {6'd0, rbbReqLineIdx_b[0*RBB_RD_ADDR_WIDTH+RBB_RD_ADDR_WIDTH-1:0*RBB_RD_ADDR_WIDTH]}; //Request ID is generated by combining the pointer and the line index
                ...
                begin
                    ...
                    begin
                        ...
                        begin
                            WrHdr_valid = 'b1; // a valid write request, 100% sent
                            WrAddrOffset_d = WrAddrOffset + 'b1; // update address since the current one has been sent
                            WrReqId[6+RBB_RD_ADDR_WIDTH-1:0] = {6'd1, rbbReqLineIdx_b[1*RBB_RD_ADDR_WIDTH+RBB_RD_ADDR_WIDTH-1:1*RBB_RD_ADDR_WIDTH]}; //Request ID is generated by combining the pointer and the line index
                ...
                begin
                    ...
                    begin
                        ...
                        begin
                            WrHdr_valid = 'b1; // a valid write request, 100% sent
                            WrAddrOffset_d = WrAddrOffset + 'b1; // update address since the current one has been sent
                            WrReqId[6+RBB_RD_ADDR_WIDTH-1:0] = {6'd2, rbbReqLineIdx_b[2*RBB_RD_ADDR_WIDTH+RBB_RD_ADDR_WIDTH-1:2*RBB_RD_ADDR_WIDTH]}; //Request ID is generated by combining the pointer and the line index
                ...
                begin
                    ...
                    begin
                        ...
                        begin
                            WrHdr_valid = 'b1; // a valid write request, 100% sent
                            WrAddrOffset_d = WrAddrOffset + 'b1; // update address since the current one has been sent
                            WrReqId[6+RBB_RD_ADDR_WIDTH-1:0] = {6'd3, rbbReqLineIdx_b[3*RBB_RD_ADDR_WIDTH+RBB_RD_ADDR_WIDTH-1:3*RBB_RD_ADDR_WIDTH]}; //Request ID is generated by combining the pointer and the line index
